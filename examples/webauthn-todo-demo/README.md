...
sequenceDiagram
  ...
  Note over App,Auth: Stored where the authenticator supports largeBlob, which registration asks for. Where it declines, written is false and the step warns.
