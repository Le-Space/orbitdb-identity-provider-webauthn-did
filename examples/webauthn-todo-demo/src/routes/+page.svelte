...
<svelte:head>
  <title>OrbitDB WebAuthn TODO Demo</title>
  <meta
    name="description"
    content="local-first peer-to-peer todo example with WebAuthn ([biometric]-Passkey, Ledger, Yubkey) Support - data stored in browser indexdb storage via OrbitDB"
  />
</svelte:head>
...
<Content>
  ...
  >
    ...
    >
    <a href="../webauthn-varsig-demo/" style="color:var(--cds-link-primary);"
      >Varsig</a
    >
  </nav>
  ...
  <div style="text-align:center;margin:2rem 0;color:var(--cds-text-secondary);">
    <small>OrbitDB WebAuthn TODO Demo</small>
    <div
