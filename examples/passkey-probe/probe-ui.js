 ...
 * that module is GPL-3.0 and this package is MIT, so it could not travel. This
 * is the same file the storage probe in `orbitdb-storage-bridge` uses — both
 * MIT, both the same author, and small enough that sharing it through a
 * package would cost more than it saves. What
...
const LANGS = ["en", "de"];
const KEY_LANG = "passkey-probe:lang";
const KEY_THEME = "passkey-probe:theme";
